...
class Secure_Ai_DemoAI:
    def __init__(self):
        logger.info("🤖 secure-ai-demo AI başlatılıyor...")
        self.model = None
        self.load_model()
...
def index():
    return f"""
    <h1>secure-ai-demo</h1>
    <p>Güvenli AI demo projesi</p>
    <h2>API Endpoints:</h2>
    <ul>
